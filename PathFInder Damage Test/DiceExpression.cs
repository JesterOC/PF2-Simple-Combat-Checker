...
// https://stackoverflow.com/questions/1250994/parsing-dice-expressions-e-g-3d65-in-c-where-to-start
...
namespace PathFInder_Damage_Test
{
    ...
    public class DiceExpression
    {
        ...
        public DiceExpression(string expression, DiceExpressionOptions options)
        {
            ...
            var tokens = expression.Replace("+", " + ").Replace("-", " - ").Split(charSeparators, StringSplitOptions.RemoveEmptyEntries);
        ...
        {
            private static readonly Random roller = new Random((int)DateTime.Now.Ticks & 0x0000FFFF);
